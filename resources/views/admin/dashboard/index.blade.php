                ...
                <div class="card text-white bg-primary">
                    ...
                    <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
                        ...
                        <canvas class="chart chartjs-render-monitor" id="card-chart1" height="140"
                            style="display: block; height: 70px; width: 169px;" width="338"></canvas>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-info">
                    ...
                    <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
                        ...
                        <canvas class="chart chartjs-render-monitor" id="card-chart2" height="140" width="338"
                            style="display: block; height: 70px; width: 169px;"></canvas>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-warning">
                    ...
                    <div class="c-chart-wrapper mt-3" style="height:70px;">
                        ...
                        <canvas class="chart chartjs-render-monitor" id="card-chart3" height="140" width="402"
                            style="display: block; height: 70px; width: 201px;"></canvas>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-danger">
                    ...
                    <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
                        ...
                        <canvas class="chart chartjs-render-monitor" id="card-chart4" height="140" width="338"
                            style="display: block; height: 70px; width: 169px;"></canvas>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="c-chart-wrapper" style="height:300px;margin-top:40px;">
                    ...
                    <canvas class="chart chartjs-render-monitor" id="main-chart" height="600" width="1718"
                        style="display: block; height: 300px; width: 859px;"></canvas>
                </div>
            </div>
