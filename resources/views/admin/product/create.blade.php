                            ...
                            <div class="nav-tabs-boxed">
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#profile" role="tab"
                                            aria-controls="profile" aria-selected="false">Obrázky</a></li>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="home" role="tabpanel">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <textarea form="product_form" class="form-control" name="long_description"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <textarea form="product_form" class="form-control" name="short_description"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input form="product_form" class="form-control" name="quantity" type="text"
                                                    value="{{ old('quantity') }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input form="product_form" id="parameters_value" class="form-control"
                                                    type="text" name="parameters[value][]" placeholder="Parametry hodnoty">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <button class="btn btn-success" form="product_form"
                                    ...
                                    <div class="tab-pane" id="profile" role="tabpanel">
                                        ...
                                        <form
                                            ...
                                            id="image_uploader" class="dropzone">
                                            @csrf
