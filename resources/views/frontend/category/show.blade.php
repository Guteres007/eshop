                            ...
                            <div class="block-sidebar__item">
                                <div class="widget-filters widget widget-filters--offcanvas--mobile" data-collapse
                                    ...
                                    <div class="widget-filters__actions d-flex">
                                        ...
                                        <button onclick="return productFilteringReset()"
                                            class="btn btn-secondary btn-sm">Resetovat</button>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="view-options__control">
                                        ...
                                        <div>
                                            <select class="form-control form-control-sm" name="" id=""
                                                onchange="return productOrderBy(this)">
                                                <option value="init" {{ $ordering != 'sale' ? 'selected' : '' }}>Výchozí
                                                </option>
                                                <option value="sale" {{ $ordering == 'sale' ? 'selected' : '' }}>
                                                    Nejprodávanejší</option>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <a href="{{ route('frontend.product.show', $product->slug) }}"
                                            ...
                                            <div class="product-card product-card--hidden-actions">
                                                ...
                                                <div class="product-card__actions">
                                                    ...
                                                    @if ($product->action && $product->price > 0)
                                                        <div class="product-card__prices">
                                                            <span class="product-card__new-price">
                                                                {{ \App\Helpers\PriceHelper::format_price_with_currency($product->action_price) }}</span>
                                                            <span class="product-card__old-price">
                                                                {{ \App\Helpers\PriceHelper::format_price_with_currency($product->price) }}</span>
                                                        </div>
                                                    @else
                                                        <div class="product-card__prices">
