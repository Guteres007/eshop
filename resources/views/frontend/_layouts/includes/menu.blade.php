                ...
                <div class="mobile-header__body">
                    <button class="mobile-header__menu-button">
                        <svg width="18px" height="14px">
                            <use xlink:href="/theme-v1/images/sprite.svg#menu-18x14"></use>
                        </svg>
                    </button>
                            ...
                            <form class="search__form" action="">
                                ...
                                <button class="search__button search__button--type--submit" type="submit">
                                    <svg width="20px" height="20px">
                                        <use xlink:href="/theme-v1/images/sprite.svg#search-20"></use>
                                    </svg>
                                </button>
                    ...
                    <div class="mobile-header__indicators">
                        ...
                        <div class="indicator indicator--mobile d-sm-flex d-none">
                            <a href="wishlist.html" class="indicator__button">
                                <span class="indicator__area">
                                    <svg width="20px" height="20px">
                                        <use xlink:href="/theme-v1/images/sprite.svg#heart-20"></use>
                                    </svg>
                        ...
                        <div class="topbar-dropdown">
                            <button class="topbar-dropdown__btn" type="button">
                                ...
                                <svg width="7px" height="5px">
                                    <use xlink:href="/theme-v1/images/sprite.svg#arrow-rounded-down-7x5"></use>
                                </svg>
                            </button>
                                        ...
                                        <li class="menu__item">
                                            ...
                                            <a class="menu__item-link" href="">
                                                <div class="menu__item-icon"><img
                                                        srcset="/theme-v1/images/languages/language-1.png 1x, /theme-v1/images/languages/language-1@2x.png 2x"
                                                        src="/theme-v1/images/languages/language-1.png" alt=""></div>
                                                English
                                            </a>
                                        </li>
                                        <li class="menu__item">
                                            ...
                                            <a class="menu__item-link" href="">
                                                <div class="menu__item-icon"><img
                                                        srcset="/theme-v1/images/languages/language-2.png 1x, /theme-v1/images/languages/language-2@2x.png 2x"
                                                        src="/theme-v1/images/languages/language-2.png" alt=""></div>
                                                French
                                            </a>
                                        </li>
                                        <li class="menu__item">
                                            ...
                                            <a class="menu__item-link" href="">
                                                <div class="menu__item-icon"><img
                                                        srcset="/theme-v1/images/languages/language-3.png 1x, /theme-v1/images/languages/language-3@2x.png 2x"
                                                        src="/theme-v1/images/languages/language-3.png" alt=""></div>
                                                German
                                            </a>
                                        </li>
                                        <li class="menu__item">
                                            ...
                                            <a class="menu__item-link" href="">
                                                <div class="menu__item-icon"><img
                                                        srcset="/theme-v1/images/languages/language-4.png 1x, /theme-v1/images/languages/language-4@2x.png 2x"
                                                        src="/theme-v1/images/languages/language-4.png" alt=""></div>
                                                Russian
                                            </a>
                                        </li>
                                        <li class="menu__item">
                                            ...
                                            <a class="menu__item-link" href="">
                                                <div class="menu__item-icon"><img
                                                        srcset="/theme-v1/images/languages/language-5.png 1x, /theme-v1/images/languages/language-5@2x.png 2x"
                                                        src="/theme-v1/images/languages/language-5.png" alt=""></div>
                                                Italian
                                            </a>
                                        </li>
                                    </ul>
                        ...
                        <div class="nav-panel__indicators">
                                ...
                                <div class="indicator__dropdown">
                                    <div class="search search--location--indicator ">
                                        <div class="search__body">
                                            ...
                                            <div
                                                class="search__suggestions suggestions suggestions--location--indicator">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="indicator indicator--trigger--click">
                                <a href="account-login.html" class="indicator__button">
                                    <span class="indicator__area">
                                        <svg width="20px" height="20px">
                                            <use xlink:href="/theme-v1/images/sprite.svg#person-20"></use>
                                        </svg>
                                    </span>
                                </a>
                                <div class="indicator__dropdown">
                                    <div class="account-menu">
                                        ...
                                        <a href="account-dashboard.html" class="account-menu__user">
                                            <div class="account-menu__user-avatar">
                                                <img src="/theme-v1/images/avatars/avatar-3.jpg" alt="">
                                            </div>
