                ...
                <div class="nav-panel__container container">
                    <div class="nav-panel__row">
                        <div class="nav-panel__logo">
                            <a href="/">
                                <!-- logo -->
                                <strong class="text-white">SHOPLY.CZ</strong>
                                <!-- logo / end -->
                            </a>
                        </div>
                        <!-- .nav-links -->
                            ...
                            <div class="indicator indicator--trigger--click">
                                ...
                                <div class="indicator__dropdown">
                                    <div class="search search--location--indicator ">
                                        <div class="search__body">
                                            <form class="search__form" action="/nope" method="post">
                                                <input class="search__input" name="search" placeholder="Najít produkt"
                                                    aria-label="Najít produkt" type="text" autocomplete="off">
                            ...
                            <div class="indicator indicator--trigger--click">
                                <a href="{{ route('frontend.cart.index') }}" class="indicator__button">
                                    <span class="indicator__area">
                                        ...
                                        <span class="indicator__value">{{ $cart_products->count() }}</span>
                                    </span>
                                </a>
                                ...
                                <div class="indicator__dropdown">
                                    <div class="account-menu">
                                        @if (!Auth::user())
                                            ...
                                            <form class="account-menu__form" action="{{ route('login') }}"
                                                method="POST">
                                                @csrf
                                                ...
                                                <div class="form-group account-menu__form-button">
                                                    <button type="submit" class="btn btn-primary btn-sm">Přihlásit
                                                        se</button>
                                                </div>
                                                <div class="account-menu__form-link"><a
                                                        href="{{ route('login') }}">Vytvořit účet</a></div>
                                            </form>
                                        ...
                                        @else
                                            ...
                                            <a href="account-dashboard.html" class="account-menu__user">
                                                ...
                                                <div class="account-menu__user-info">
                                                    <div class="account-menu__user-name">{{ Auth::user()->name }}
                                                    </div>
                                                    <div class="account-menu__user-email">{{ Auth::user()->email }}
                                                    </div>
                                                </div>
                                            </a>
                                            <div class="account-menu__divider"></div>
